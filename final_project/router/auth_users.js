...
let users = [];  // This should be populated with registered users
...
// POST /login - only registered users can login
...
regd_users.put("/auth/review/:isbn", (req, res) => {
    ...
    const review = req.query.review;  // Assuming review is sent as query parameter
    const username = req.user.username;  // username from authenticated middleware
